...
<html>
	...
	<body>
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Bài hát đã lưu</h2>
					...
					<table class="table table-striped">
						...
						<c:forEach items="${list }" var="normalUserSong" varStatus="status">
							<tr>
								...
								<td><a href="<%=contextPath %>/SongServlet?info=removeFollow&songId=${normalUserSong.song.songId}">Xóa</a></td>
							</tr>
						</c:forEach>
					</table>
				</section>
