					...
					<table class="table">
						...
						<tr>
							...
							<td>
								...
								<label class="radio-inline">
									<input type="radio" name="sex" value="0" checked />Khác
								</label>
							</td>
						</tr>
						<tr>
							<td colspan="2"><button class="btn btn-primary">Lưu</button></td>
							<!--<td></td>-->
						</tr>
					</table>
