...
<html>
	...
	<body>
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Ca sĩ theo dõi</h2>
					...
					<table class="table table-striped">
						...
						<c:forEach items="${list }" var="normalUserSinger" varStatus="status">
							<tr>
								...
								<td><a href="<%=contextPath %>/SingerServlet?info=removeFollow&singerId=${normalUserSinger.singer.singerId}">Xóa</a></td>
							</tr>
						</c:forEach>
					</table>
				</section>
