...
<html>
	...
	<body>
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Album đã lưu</h2>
					...
					<table class="table table-striped">
						...
						<c:forEach items="${list }" var="normalUserAlbum" varStatus="status">
							<tr>
								...
								<td><a href="<%=contextPath %>/AlbumServlet?info=removeFollow&albumId=${normalUserAlbum.album.albumId}">Xóa</a></td>
							</tr>
