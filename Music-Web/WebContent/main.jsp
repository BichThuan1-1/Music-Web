...
<html>
	<head>
		...
		<title>Nền Tảng Nghe Nhạc Số</title>
					...
					<div class="col-sm-offset-3 col-sm-6 col-md-offset-3 col-md-6">
						<form action="<%=contextPath %>/SongServlet?info=search" method="post">
							<div class="form-group input-group">
								<input type="search" class="form-control" placeholder="Bạn muốn tìm kiếm bài hát..." name="songTitle"/>
			...
			<div class="container main-content">
				<div class="row">
					...
					<div class="col-md-7">
						<!-- Đề xuất cho hôm nay -->
						<section>
							<h2 class="theme-color">Nhạc mới mỗi ngày</h2>
							<div class="row">
					...
					<!-- phần bên trái kết thúc -->
					<!-- phần bên phái bắt đầu -->
					<div class="col-md-offset-1 col-md-4">
						
						<!-- Bảng xếp hạng lượt tải xuống -->
						<section>
							<h2 class="theme-color">Bảng xếp hạng lượt tải</h2>
							<table class="table">
								<c:forEach items="${requestScope.dRank }" var="dsong" varStatus="status">
									<tr>
										...
										<td><span class="fa fa-download theme-color"></span>&nbsp;<small><c:out value="${dsong.songDldtimes }"></c:out>lượt</small></td>
									</tr>
								</c:forEach>
							</table>
						</section>
