...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Người dùng bị chặn</h2>
			
				<form action="<%=contextPath %>/NormalUserServlet?info=ban" method="post" class="form-horizontal">
					<table class="table">
						<tr>
							<td><label class="control-label">ID người dùng</label></td>
							<td><input type="text" class="form-control" name="userId" /></td>
						</tr>
						<tr>
							<td colspan="2"><button class="btn btn-primary">Chặn</button></td>
						</tr>
					</table>
				</form>
			</div>
