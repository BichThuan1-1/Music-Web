...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Thay đổi mật khẩu</h2>
			
				<form action="<%=contextPath %>/AdminServlet?info=psw" method="post" class="form-horizontal">
					<table class="table">
						<tr>
							<td><label class="control-label">Mật khẩu hiện tại</label></td>
						...
						<tr>
							<td colspan="2"><button type="submit" class="btn btn-primary">Thay đổi</button></td>
						</tr>
					</table>
