...
<html>
					...
					<div class="col-md-12">
						<form action="<%=contextPath %>/SongServlet?info=find&pageNum=1" method="post" id="formSub">
							<div class="btn-group">
								...
								<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modalUpdate"><span class="fa fa-gear"></span>&nbsp;Sửa đổi bài hát</button>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalAddLabel">Thêm mới bài hát</h4>
					</div>
					<form action="<%=contextPath %>/SongServlet?info=add" method="post" enctype="multipart/form-data" >
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Tệp bài hát</label>
								<input type="file" name="filename" required/>
								<p class="help-block">chỉ hỗ trợ phương thức .mp3</p>
							</div>
						</div>
					...
					<form action="<%=contextPath %>/SongServlet?info=update" method="post" enctype="multipart/form-data">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="file" name="filename" required/>
								<p class="help-block">chỉ hỗ trợ tệp .mp3</p>
							</div>
						</div>
						<div class="modal-footer">
	...
	<script type="text/javascript">
		...
		function firstPage(){
			if(currentPage == 1){
				alert("Đây là trang đầu tiên của dữ liệu");
				return false;
			}else{
		...
		function lastPage(){
			if(currentPage == totalPage){
				alert("Đây là trang cuối cùng của dữ liệu");
				return false;
			}else{
