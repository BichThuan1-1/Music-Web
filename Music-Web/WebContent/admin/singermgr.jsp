					...
					<div class="col-md-12">
						<form action="<%=contextPath %>/SingerServlet?info=find&pageNum=1" method="post" id="formSub">
							<div class="btn-group">
								...
								<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modalUpdate"><span class="fa fa-gear"></span>&nbsp;Chỉnh sửa ca sĩ</button>
								...
								<tr>
									<td colspan="4">
										<ul class="pagination">
											...
											<li><a href="#" onclick="nextPage();">Trang sau</a></li>
					...
					<form action="<%=contextPath %>/SingerServlet?info=add" method="post" enctype="multipart/form-data">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<p class="help-block">Chỉ hỗ trợ định dạng.jpg or .png</p>
							</div>
						</div>
		...
		<div class="modal fade" id="modalUpdate" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="modalUpdateLabel">Chỉnh sửa ca sĩ</h4>
					</div>
	...
	<script type="text/javascript">
		...
		function nextPage(){
			if(currentPage == totalPage){
				alert("Đây là trang dữ liệu cuối cùng");
				return false;
			}else{
